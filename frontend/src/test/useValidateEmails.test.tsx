...
describe('useValidateEmails', () => {
  ...
  it('should handle successful validation', async () => {
    ...
    expect(mockAxiosInstance.post).toHaveBeenCalledWith('/api/validate', {
      emails: ['test@example.com', 'invalid@email'],
      enable_smtp: false,
      enable_catch_all: false,
    }, {
  ...
  it('should handle missing API key', async () => {
    ...
    vi.mocked(obtainJwtToken).mockRejectedValue(new Error('VITE_API_KEY environment variable is required in development mode'))
    ...
    expect(errorMessage).toContain('VITE_API_KEY environment variable is required in development mode')
  })
